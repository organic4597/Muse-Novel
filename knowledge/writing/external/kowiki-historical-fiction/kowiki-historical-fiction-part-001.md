---
id: kowiki-historical-fiction-part-001
title: 역사소설 장르 배경
category: 장르 자료
kind: genre
genres: [역사소설, 시대극]
domains: []
tags: [역사, 역사소설, 고증, 시대]
summary: 역사적 시대와 인물을 활용하는 역사소설의 장르 배경
sourceUrl: https://ko.wikipedia.org/wiki/역사_소설
license: CC BY-SA 4.0
accessedAt: 2026-09-04
---

역사소설(歷史小設, Historical novel)은 역사 시대를 배경으로 실존했던 특정인이나 역사상 사건을 소재로 쓴 소설이다. 역사상 사건이나 배경을 기초로 거기에 상상으로써 만든 인물이나 타 사건이 추가될 수 있다. 작가의 역사관이나 세계관을 좇아 기존 역사상 사실이 변형되기도 한다. 새로운 역사 해석을 목표하거나 과거 파란만장한 역사를 재현시키려는 의도를 위시해 어떤 의미로든지 소재인 ‘역사성’을 중시하는 작품과 현대에 적합한 과제를 추구하는 방편으로서만 역사상 배경을 빌릴 뿐 역사 묘사 자체를 목적하지 않는 작품으로 대별 가능하다.
...
== 외부 링크 ==
 위키미디어 공용에 역사소설 관련 미디어 분류가 있습니다.
---
출처: https://ko.wikipedia.org/wiki/역사_소설
라이선스: CC BY-SA 4.0
가져온 날짜: 2026-09-04

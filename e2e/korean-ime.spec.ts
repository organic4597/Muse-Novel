 ...
 *    [data-slate-editor]. Comes from inline-suggestion-plugin.tsx.
 *  - InlineSuggestionPlugin shortcuts:
 *      Ctrl+Alt+Space = explicit suggestion
 *      Tab = accept all, Alt+Right = accept next word, Escape = reject
...
test.describe.serial('Korean IME — muse-novel editor', () => {
  // -------------------------------------------------------------------------
  ...
  test.beforeAll(async ({ browser }) => {
    const page = await browser.newPage({ storageState: E2E_AUTH_STATE_PATH });

 ...
 *
 * InlineGhostText (inline-suggestion-plugin.tsx) renders:
...
export async function waitForGhostText(
  ...
  // carrying the pointer-events-none class set by InlineGhostText.
...
export async function openWritePageWithChapter(
  ...
  await page.getByLabel('새 챕터', { exact: true }).click();

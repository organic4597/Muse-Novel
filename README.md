...
- 작품별 연호·달력과 회차별 연·월·일·시간 또는 상대 시점 기록
- 실제 사실·독자 공개 정보·인물별 지식/의심/믿음을 회차 기준으로 관리
- 사건·선택·결과와 복선 심기·재언급·회수를 연결하는 세로형 인과 보드
- `이번 화 마감`에서 원고 근거가 있는 상태·지식·사건 후보를 검토한 뒤 선택 반영
